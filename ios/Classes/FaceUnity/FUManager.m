...
{
    if(_isInitBeauty == NO){
        [[FURenderer shareRenderer] setupWithData:nil dataSize:0 ardata:nil authPackage:(void *)key.data.bytes authSize:(int)key.data.length shouldCreateContext:YES];
        _isInitBeauty     = YES;
...
- (void)loadFilter:(NSDictionary *)fliterParams
{
    ...
    dispatch_async(_asyncLoadQueue, ^{
        if (self->items[FUNamaHandleTypeBeauty]) {
            /* 默认精细磨皮 */
            [FURenderer itemSetParam:self->items[FUNamaHandleTypeBeauty] withName:@"filter_name" value:[fliterParams objectForKey:@"filterName"]];
            [FURenderer itemSetParam:self->items[FUNamaHandleTypeBeauty] withName:@"filter_level" value:[fliterParams objectForKey:@"filterLevel"]];
            [FURenderer itemSetParam:self->items[FUNamaHandleTypeBeauty] withName:@"color_level" value:[fliterParams objectForKey:@"colorLevel"]];
             [FURenderer itemSetParam:self->items[FUNamaHandleTypeBeauty] withName:@"red_level" value:[fliterParams objectForKey:@"redLevel"]];
             [FURenderer itemSetParam:self->items[FUNamaHandleTypeBeauty] withName:@"blurLevel" value:  [fliterParams objectForKey:@"blur_level"]];
            [FURenderer itemSetParam:self->items[FUNamaHandleTypeBeauty] withName:@"eye_enlarging" value:  [fliterParams objectForKey:@"eyeEnlarging"]];
            [FURenderer itemSetParam:self->items[FUNamaHandleTypeBeauty] withName:@"cheek_thinning" value:[fliterParams objectForKey:@"cheekThinning"]];
