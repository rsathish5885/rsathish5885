...
-(NSDictionary*)toMap {
  return [NSDictionary dictionaryWithObjectsAndKeys:(self.beautyKey ? self.beautyKey : [NSNull null]), @"beautyKey", (self.logDir ? self.logDir : [NSNull null]), @"logDir", (self.logLevel ? self.logLevel : [NSNull null]), @"logLevel", nil];
}
@end
...
-(NSDictionary*)toMap {
  return [NSDictionary dictionaryWithObjectsAndKeys:(self.filterLevel ? self.filterLevel : [NSNull null]), @"filterLevel", (self.colorLevel ? self.colorLevel : [NSNull null]), @"colorLevel", (self.redLevel ? self.redLevel : [NSNull null]), @"redLevel", (self.blurLevel ? self.blurLevel : [NSNull null]), @"blurLevel", (self.eyeBright ? self.eyeBright : [NSNull null]), @"eyeBright", (self.eyeEnlarging ? self.eyeEnlarging : [NSNull null]), @"eyeEnlarging", (self.cheekThinning ? self.cheekThinning : [NSNull null]), @"cheekThinning", (self.filterName ? self.filterName : [NSNull null]), @"filterName", nil];
}
@end

void NEFTFaceUnityEngineApiSetup(id<FlutterBinaryMessenger> binaryMessenger, id<NEFTFaceUnityEngineApi> api) {
  {
